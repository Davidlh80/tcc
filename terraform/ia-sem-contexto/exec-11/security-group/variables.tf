...
variable "ingress_rules" {
  description = "Lista de regras de entrada. Cada regra define descricao, portas, protocolo e CIDRs de origem."
  type = list(object({
    description = string
    from_port   = number
    to_port     = number
...
variable "egress_rules" {
  description = "Lista de regras de saida. Cada regra define descricao, portas, protocolo e CIDRs de destino."
  type = list(object({
    description = string
    from_port   = number
    to_port     = number
